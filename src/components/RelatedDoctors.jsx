...
const RelatedDoctors = ({docId, speciality}) => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      <h1 className='text-xl font-medium text-gray-700'>Related Doctors</h1>
      <div className='w-full grid grid-cols-auto gap-4 pt-5 gap-y-6 px-3 sm:px-0 justify-evenly'>
