...
const Contact = () => {
  return (
    <div>
      ...
      <div className='my-10 flex flex-col justify-center md:flex-row gap-12 text-sm'>
        ...
        <div className='flex flex-col justify-center gap-5'>
          ...
          <button className='rounded-lg border border-green-500 px-8 py-4 text-sm hover:bg-green-500 hover:text-white transition-all duration-500'>Explore Jobs</button>
        </div>
      </div>
    </div>
  )
