  ...
  return (
    <form className='min-h-[80vh] flex items-center'>
      <div className='flex flex-col gap-3 m-auto items-start p-8 min-w-[340px] sm:min-w-96 border rounded-xl text-zinc-600 text-sm shadow-2xl'>
        ...
        <button className='bg-green-500 text-white w-full rounded-md text-base h-10 hover:bg-green-400 transition-all duration-500'>{state === 'Sign Up' ? "Create Account" : "Login"} </button>
        {
          state === "Sign Up" 
